...
(
  cell5m integer NOT NULL,
  shape geometry,
  CONSTRAINT cell5m_pkey PRIMARY KEY (cell5m)
);

-- Index: idx_cell5m_shape

-- DROP INDEX idx_cell5m_shape;

CREATE INDEX idx_cell5m_shape
  ON cell5m
  USING gist
  (shape);

-- Create extra indicies 
CREATE INDEX  IDX_AEZ_CODE  on  AEZ_CODE  (  AEZ_CODE  ASC);
CREATE INDEX  IDX_AEZ_TEXT  on  AEZ_TEXT  (  AEZ_TEXT  ASC);
CREATE INDEX  IDX_AREA_WBODY  on  AREA_WBODY  (  AREA_WBODY, cell5m  ASC);
CREATE INDEX  IDX_CELL_VALUES on  CELL_VALUES (  CELL_VALUES ASC);
CREATE INDEX  IDX_FS_CODE on  FS_CODE (  FS_CODE ASC);
CREATE INDEX  IDX_FS_NAME on  FS_NAME (  FS_NAME ASC);
CREATE INDEX  IDX_GAUL_2008_0 on  GAUL_2008_0 (  GAUL_2008_0 ASC);
CREATE INDEX  IDX_GAUL_2008_1 on  GAUL_2008_1 (  GAUL_2008_1 ASC);
CREATE INDEX  IDX_GAUL_2008_2 on  GAUL_2008_2 (  GAUL_2008_2 ASC);
CREATE INDEX  IDX_GAUL_2012_0 on  GAUL_2012_0 (  GAUL_2012_0 ASC);
CREATE INDEX  IDX_GAUL_2012_1 on  GAUL_2012_1 (  GAUL_2012_1 ASC);
CREATE INDEX  IDX_GAUL_2012_2 on  GAUL_2012_2 (  GAUL_2012_2 ASC);
CREATE INDEX  IDX_MSH_100K_ID on  MSH_100K_ID (  MSH_100K_ID ASC);
CREATE INDEX  IDX_MSH_20K_ID  on  MSH_20K_ID  (  MSH_20K_ID  ASC);
CREATE INDEX  IDX_MSH_250K_ID on  MSH_250K_ID (  MSH_250K_ID ASC);
CREATE INDEX  IDX_MSH_500K_ID on  MSH_500K_ID (  MSH_500K_ID ASC);
CREATE INDEX  IDX_MSH_50K_ID  on  MSH_50K_ID  (  MSH_50K_ID  ASC);
CREATE INDEX  IDX_PD_RU00 on  PD_RU00 (  PD_RU00 ASC);
CREATE INDEX  IDX_PD_RU05 on  PD_RU05 (  PD_RU05 ASC);
CREATE INDEX  IDX_subNatUnit  on  subNatUnit  (  subNatUnit  ASC);
CREATE INDEX  IDX_toppr_area_CELL5M on  toppr_area  (  cell5m, area_crop, crop, value  ASC);
CREATE INDEX  IDX_toppr_area_GAUL_2008_1  on  toppr_area  (  GAUL_2008_1, area_crop, crop, value  ASC);
CREATE INDEX  IDX_toppr_area_GAUL_2012_1  on  toppr_area  (  GAUL_2012_1, area_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_area_ISO3 on  toppr_area  (  ISO3, area_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_area2_ISO31 on  toppr_area2 (  ISO3, crop, value ASC);
CREATE INDEX  IDX_toppr_area2_ISO32 on  toppr_area2 (  ISO3, area_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_area2_ISO33 on  toppr_area2 (  ISO3, vp_crop, value ASC);
CREATE INDEX  IDX_toppr_prod_CELL5M on  toppr_prod  (  cell5m, crop, value  ASC);
CREATE INDEX  IDX_toppr_prod_GAUL_2008_1  on  toppr_prod  (  GAUL_2008_1, crop, value   ASC);
CREATE INDEX  IDX_toppr_prod_GAUL_2012_1  on  toppr_prod  (  GAUL_2012_1 , crop, value ASC);
CREATE INDEX  IDX_toppr_prod_ISO3 on  toppr_prod  (  ISO3, crop, value  ASC);
CREATE INDEX  IDX_toppr_value_CELL5M  on  toppr_value (  cell5m, vp_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_value_GAUL_2008_1 on  toppr_value (  GAUL_2008_1, vp_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_value_GAUL_2012_1 on  toppr_value (  GAUL_2012_1, vp_crop, crop, value ASC);
CREATE INDEX  IDX_toppr_value_ISO3  on  toppr_value (  ISO3, vp_crop, crop, value ASC);
