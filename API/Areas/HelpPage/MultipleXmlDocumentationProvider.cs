namespace HarvestChoiceApi.Areas.HelpPage
{
	using System;
	...
	using HarvestChoiceApi.Areas.HelpPage.ModelDescriptions;
    using System.Web;
    using System.IO;
	...
	public class MultipleXmlDocumentationProvider : IDocumentationProvider, IModelDocumentationProvider
	{
		...
		public MultipleXmlDocumentationProvider(params string[] documentPaths)
		{
            ...
            this.documentNavigators = documentPaths.Select(path => new XPathDocument(HttpContext.Current.Server.MapPath("~/bin/HarvestChoiceApi.xml"))).Select(xpath => xpath.CreateNavigator());
            ...
            //{
            //    var path = HttpContext.Current.Server.MapPath("~/bin/HarvestChoiceApi.xml");

            //    if (File.Exists(path))
            //    {
            //        var xpath = new XPathDocument(path);

            //        this.documentNavigators.Concat(xpath.CreateNavigator());
            //    }
            //}
		}
